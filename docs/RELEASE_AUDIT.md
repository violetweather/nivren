...
**1.0 is not releasable.** `niv release check .` correctly rejects the current tree because the Edition 2 freeze ends on 2027-01-26, the toolchain version is `0.10.0-beta.3`, and zero of three required independent 30-day production pilots are recorded.
