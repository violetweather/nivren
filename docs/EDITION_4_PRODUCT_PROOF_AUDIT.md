...
| Official Edition 4 package conversion | In progress | Validation, crypto, secrets, compression, CSV, and AEAD now join database, desktop, Discord, GPU, and routing as 11 Edition 4-only entry modules with Edition 4 tests; each package and the 25-package aggregate fixture pass | Convert and verify the remaining 14 official package entry modules, tests, generated references, and site examples |
