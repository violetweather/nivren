...
| Official Edition 4 package conversion | In progress | `nivren_validation`, `nivren_crypto`, and `nivren_secrets` now join database, desktop, Discord, GPU, and routing as Edition 4-only entry modules and tests; each package and the 25-package aggregate fixture pass | Convert and verify the remaining 17 official package entry modules, tests, generated references, and site examples |
