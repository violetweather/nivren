...
| Database and data | Parameterized SQL, transactions, typed rows/JSON/CSV/columnar packages, Redis TLS/pools/Cluster, bounded Edition 4 driver/pool/migration/page contracts, and an opaque-handle `Native within "database"` adapter with VM/native-control equivalence and deterministic cleanup evidence | Released PostgreSQL/MySQL/SQLite host implementations, query-stream iterator, pool integration, migration reference service, and platform driver fixtures |
