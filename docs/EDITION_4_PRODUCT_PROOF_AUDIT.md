...
| Official Edition 4 package conversion | In progress | Validation, crypto, secrets, compression, CSV, AEAD, testing, and statistics now join database, desktop, Discord, GPU, and routing as 13 Edition 4-only entry modules with Edition 4 tests; each package and the 25-package aggregate fixture pass | Convert and verify the remaining 12 official package entry modules, tests, generated references, and site examples |
